...
import com.careLink.Member.result.JoinResult;
import com.careLink.Member.result.LoginResult;
import com.careLink.Member.vo.MemberDto;
import com.careLink.Member.dto.SignInDto;
...
public class AuthController {
    ...
    public LoginResult login(@RequestBody SignInDto signInDto) {
        ...
        //AccessToken 생성 ---------------------------------------
        String accessToken = jwtUtil.createToken(signInDto.getId());
