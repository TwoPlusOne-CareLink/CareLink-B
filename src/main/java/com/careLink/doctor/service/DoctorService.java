...
public interface DoctorService {
    public String signup(DoctorDto doctor, DoctorInfoEntity doctorinfo); // //의사회원가입(성민)
    ...
    public List<DoctorCounselingListDto> doctorGetList(int departmentId); // 의사의 진료 과목에 따른 댓글이 안 달린 상담리스트 가져오기
